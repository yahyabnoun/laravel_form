                ...
                <form action="{{ route('add') }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col text-center">
                            ...
                            <p class="text-h3">Joignez-vous à nous pour notre réunion en ligne gratuite prévue le 9
                                octobre à 18h30. Cette réunion est spécialement conçue pour vous offrir l'occasion de
